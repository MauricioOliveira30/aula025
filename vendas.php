...
<body>
    ...
    <div class="container">
        <a href="frmvendas.php" class="btn btn-primary">Novo</a>
            ...
            <tbody>
                <?php foreach ($vendas as $v) { ?>
                    <tr>
                        ...
                        <th>
                            <a href="frmvendas.php?idvendas=<?php echo $v->idvendas ?>">
                        ...
                        <th>
                            <a href="frmvendas.php?op=del&idvendas=<?php echo $v->idvendas ?>">
