...
<div class="container">
    ...
    <table class="table table-success table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                <th><?php echo $cliente->idclientes ?></th>
                <th><?php echo $cliente->cliente ?></th>
                <th><?php echo $cliente->dtcad ?></th>
                <th><?php echo $cliente->valor ?></th>
                
                <th>
                    <a href="frmcliente.php?idcliente=<?php echo $cliente->idclientes ?>" >
                ...
                <th>
                    <a href="frmcliente.php?op=del&idcliente=<?php echo $cliente->idclientes ?>" >
